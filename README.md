# Angular Boot Camp example: route-query-parameters
...
**[StackBlitz for route-query-parameters](https://stackblitz.io/github/AngularBootCamp/route-query-parameters)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/route-query-parameters.git
cd route-query-parameters
npm install
npm start
```
